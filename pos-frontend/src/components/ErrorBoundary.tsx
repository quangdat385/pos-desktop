    ...
    if (this.state.hasError) {
      ...
      return (
        <main className='flex h-screen w-full flex-col items-center justify-center'>
          ...
          <div className='absolute rotate-12 rounded bg-orange px-2 text-sm text-red-600'>Error!</div>
          <button className='mt-5'>
            <a
              href='/'
              className='active:text-red-500 group relative inline-block text-sm font-medium text-white focus:outline-none focus:ring'
            >
